...
// Endpoint temporario: importa um recorte curado da ExerciseDB (licenca aberta,
// oss.exercisedb.dev) com nomes e grupos musculares traduzidos manualmente pro
// portugues, com gif de demonstracao. Roda uma vez e depois pode ser removido
// (mesmo padrao usado antes em "adiciona/remove endpoint temporario de importacao").
// Protegido pela mesma chave do setup.js.
...
export default async function handler(req, res) {
  ...
  return res.status(200).json({ ok: true, atualizados, inseridos, total: EXERCICIOS.length })
}
